...
public class SocketServer3 {
            ...
            while(true) {
                ...
                while(selecionKeys.hasNext()) {
                    ...
                    if(readyKey.isValid() && readyKey.isAcceptable()) {
                        SocketServer3.LOGGER.info("======channel通道已经准备好=======");
                        /*
                        ...
                        SocketServer3.LOGGER.info("======socket channel 建立连接=======");
                    } else if(readyKey.isValid() && readyKey.isReadable()) {
                        SocketServer3.LOGGER.info("======socket channel 数据准备完成，可以去读==读取=======");
    ...
    private static void readSocketChannel(SelectionKey readyKey) throws Exception {
        ...
        System.out.println("resoucePort:"+resoucePort);
        System.out.println("hostName:"+sourceSocketAddress.getHostName());
        System.out.println("hostString:"+sourceSocketAddress.getHostString());
        ...
        try {
            ...
            SocketServer3.LOGGER.error(e.getMessage());
        ...
        if(realLen == -1) {
            SocketServer3.LOGGER.warn("====缓存区没有数据？====");
            return;
        }
        ...
        if(message.indexOf("over") != -1) {
            ...
            contextBytes.clear();
            SocketServer3.LOGGER.info("端口:" + resoucePort + "客户端发来的信息======message : " + message);
            ...
            SocketServer3.LOGGER.info("端口:" + resoucePort + "客户端信息还未接受完，继续接受======message : " + message);
